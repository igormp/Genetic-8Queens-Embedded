...
OBJECTS += main.o
OBJECTS += UniGraphic/Display/LCD.o
OBJECTS += UniGraphic/Display/TFT.o
OBJECTS += UniGraphic/Display/TFT932x.o
OBJECTS += UniGraphic/Graphics/GraphicsDisplay.o
OBJECTS += UniGraphic/Graphics/TextDisplay.o
OBJECTS += UniGraphic/Inits/ILI9327.o
OBJECTS += UniGraphic/Inits/ILI932x.o
OBJECTS += UniGraphic/Inits/ILI9341.o
OBJECTS += UniGraphic/Inits/ILI9486.o
OBJECTS += UniGraphic/Inits/IST3020.o
OBJECTS += UniGraphic/Inits/S6D04D1.o
OBJECTS += UniGraphic/Inits/SEPS225.o
OBJECTS += UniGraphic/Inits/SSD1306.o
OBJECTS += UniGraphic/Inits/ST7565.o
OBJECTS += UniGraphic/Inits/TFT_MIPI.o
OBJECTS += UniGraphic/Inits/UC1608.o
OBJECTS += UniGraphic/Protocols/BUS16.o
OBJECTS += UniGraphic/Protocols/BUS8.o
OBJECTS += UniGraphic/Protocols/I2C_bus.o
OBJECTS += UniGraphic/Protocols/PAR16.o
OBJECTS += UniGraphic/Protocols/PAR8.o
OBJECTS += UniGraphic/Protocols/SPI16.o
OBJECTS += UniGraphic/Protocols/SPI8.o
...
INCLUDE_PATHS += -I../UniGraphic
INCLUDE_PATHS += -I../UniGraphic/Display
INCLUDE_PATHS += -I../UniGraphic/Font
INCLUDE_PATHS += -I../UniGraphic/Graphics
INCLUDE_PATHS += -I../UniGraphic/Inits
INCLUDE_PATHS += -I../UniGraphic/Protocols
...
ASM_FLAGS += -I../UniGraphic
ASM_FLAGS += -I../UniGraphic/Display
ASM_FLAGS += -I../UniGraphic/Font
ASM_FLAGS += -I../UniGraphic/Graphics
ASM_FLAGS += -I../UniGraphic/Inits
ASM_FLAGS += -I../UniGraphic/Protocols
ASM_FLAGS += -include
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m3 -mthumb -DMBED_BOOT_STACK_SIZE=4096 -DXIP_ENABLE=0 
